...
export default function PegawaiHome() {
    ...
    const fetchTotalKasbon = async () => {
        try {
            ...
            const total = data
                .filter((it) => ["pending", "approve", "reject"].includes(it.status))
                .reduce((sum, it) => {
