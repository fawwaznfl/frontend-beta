...
export default function Pegawais() {
    ...
    const columns = [
        ...
        { header: "Nama", accessor: "name" },
        {
            ...
            cell: (row) => (_jsx("div", { className: "flex flex-col items-center justify-center p-2", children: _jsx("div", { className: "w-24 h-24 rounded-full overflow-hidden border", children: _jsx("img", { src: row.foto_karyawan ?? "/default-user.png", className: "w-full h-full object-cover" }) }) })),
        },
